...
const TokenSwichPanel = () => {
    ...
    return (
        <button onClick={swichFN} className="relative mx-auto -mt-2.5 flex h-[42px] w-[42px] items-center justify-center rounded-full border-4 border-valuerouter-switch bg-valuerouter-switch disabled:opacity-60  ">
