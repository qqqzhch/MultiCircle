  ...
  return (
    <>
      <button
        ...
        className="skt-w skt-w-input skt-w-button flex w-auto flex-shrink-0 items-center justify-start bg-transparent p-2 py-0 hover:bg-transparent sm:justify-between"
      >
